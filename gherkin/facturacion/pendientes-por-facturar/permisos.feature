...
Característica: Permisos y Control de Acceso en Pendientes por Facturar
  ...
  @autoP0 @prioridadExtrema @ejecutivoFacturacion @pendientesPorFacturar @regresion
  ...
  @autoP0 @prioridadExtrema @responsableFacturacion @pendientesPorFacturar @unhappyPath
  ...
  @autoP0 @prioridadExtrema @superusuarioAdmision @pendientesPorFacturar @unhappyPath
  ...
  @autoP0 @prioridadExtrema @ejecutivoFacturacion @pendientesPorFacturar @unhappyPath
  ...
  @autoP0 @prioridadExtrema @ejecutivoFacturacion @pendientesPorFacturar @happyPath
